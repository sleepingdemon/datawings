...
COMMENT ON TABLE Item IS '零部件';
COMMENT ON COLUMN Item.id IS '编号';
COMMENT ON COLUMN Item.part_number IS '零部件编号';
COMMENT ON COLUMN Item.status IS '状态（0正常 1删除 2停用）';
COMMENT ON COLUMN Item.create_by IS '创建者';
COMMENT ON COLUMN Item.create_date IS '创建时间';
COMMENT ON COLUMN Item.update_by IS '更新者';
COMMENT ON COLUMN Item.update_date IS '更新时间';
COMMENT ON COLUMN Item.remarks IS '备注信息';
...
COMMENT ON COLUMN test_data.part_number IS '零部件编号';
...
COMMENT ON COLUMN test_data_child.part_number IS '零部件编号';
